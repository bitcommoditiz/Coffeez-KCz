...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "KCz " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"a.bitcommoditiz.org", "kcz.bitcommoditiz.org"},
    {"b.bitcommoditiz.org", "kcz.bitcommoditiz.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"a.bitcommoditiz.org", "testnet.kcz.bitcommoditiz.org"},
    {"b.bitcommoditiz.org", "testnet.kcz.bitcommoditiz.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. KCz is probably already running."), addrBind.ToString().c_str());
        else
