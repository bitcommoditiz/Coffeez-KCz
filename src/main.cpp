...
uint256 hashGenesisBlock("0x9a5ee48f2978718bfa4b46ce381debae7e1e800d10f6b154390ed1b7660e8ee0");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 18); // KCz: starting difficulty is 1 / 2^10
...
double nUnderlyingBirthValue = 103; //the value of the underlying commodity in US Dollar the date the bitcommoditiz was born
...
const string strMessageMagic = "KCz Signed Message:\n";
...
{
    // KCz: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    if ((pindexLast->nHeight+1) % nInterval != 0)
    {
        ...
        if(!fCalledForTemplate){
            ...
            std::ostringstream oss;
           	oss << year;
            string myString="GET /webservice/v1/symbols/KCH"+oss.str()+".NYB/quote?format=json HTTP/1.1\r\n"
                     "Host: finance.yahoo.com\r\n"
                     "User-Agent: Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1)\r\n"
                     "Connection: close\r\n"
                     "\r\n";

           //http://finance.yahoo.com/webservice/v1/symbols/KCH15.NYB/quote?format=json
    ...
    // KCz: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // KCz: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // KCz: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xed96b3193e7a318bc05f468dee2020cb58661b15af1d789a5f8171720cafae23");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Who died today, not me KCz !";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x1d04efc668f0e5b3d667051e10ac9d139d272930a37bf07e139d1c8bb8911d6b"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // KCz: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("KCzMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("KCzMiner : ProcessBlock, block not accepted");
    }
